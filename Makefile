...
BOT_SRC := src/tenet_bot.c src/bot_config.c src/bot_http.c src/bot_memory.c src/bot_ollama.c src/bot_protocol.c src/bot_util.c
SERVER_OBJ := $(SERVER_SRC:.c=.o)
BOT_OBJ := $(BOT_SRC:.c=.o)
SERVER_HEADERS := src/tenet.h src/server_internal.h
BOT_HEADERS := src/bot_config.h src/bot_http.h src/bot_memory.h src/bot_ollama.h src/bot_protocol.h src/bot_util.h
